...
def sorted_triple(caption, rule_kg_triples, model, tokenizer):
    sentence_pairs = [caption, rule_kg_triples]
...
# Load the dataset
with open("vqa_rad/processed_vqa_with_kg.json", "r") as f:
    data = json.load(f)
...
for num, item in enumerate(data):
    print(f"Processing sequence number: {num}")
    caption = item["caption"]
    kg_triplets = item["kg_triplets"]
...
with open("vqa_rad/sorted_vqa_with_rules.json", "w") as f:
