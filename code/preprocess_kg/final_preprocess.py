...
# with open('../../MedEX/Data/MashQA_kg_train_data_3000.json','r') as f:
# 	test=json.load(f)

# tt_context_list=[]
# for i,v in enumerate(test):
# 	tt_context_list.append(test[i]["context"])

# print(len(tt_context_list))

train_data=[]

for item,val in enumerate(mash_train_data):
	print("context no: ",item)
	# orig_context = mash_train_data[item]["context"]
	# if orig_context in tt_context_list:
	# 	print("already in test")
	# else:
	# print("im here")
	# print(orig_context[:25])
