...
from question_answering_st import QuestionAnsweringModel, QuestionAnsweringArgs
...
# with open('Data/covidQA_kg_train_data.json', 'r') as f:
#     train_data = json.load(f)


# with open('Data/covidQA_kg_val_data.json', 'r') as f:
...
with open('Data/MashQA_kg_val_data_10.json', 'r') as f:
    dev_data = json.load(f)
...
# model = QuestionAnsweringModel("bert", "dmis-lab/biobert-v1.1", args=train_args)
# model = QuestionAnsweringModel("bert", "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext", args=train_args)
...
print("##########  !!!!!!! Roberta Top 40 mashqa without Attention############  !!!!!!!!!!")
print("!!!!!!! Exact Match !!!!!!!!!")
print(final_em)
